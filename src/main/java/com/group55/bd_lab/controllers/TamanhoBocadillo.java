 ...
 * @author anjab, daniel
 */
public class TamanhoBocadillo extends JFrame {
    ...
    public void adicionarActionButton() {
        // Change State
        this.state = TamanhoBocadillo.ADD_STATE;
    ...
    public void modificarActionButton() {
        // Change State
        this.state = TamanhoBocadillo.UPDATE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void eliminarActionButton() {
        // Change State
        this.state = TamanhoBocadillo.DELETE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void cancelarActionButton() {
        // Change State
        this.state = TamanhoBocadillo.SELECT_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void inactivarActionButton() {
        // Change State
        this.state = TamanhoBocadillo.INACTIVATE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void reactivarActionButton() {
        // Change State
        this.state = TamanhoBocadillo.ACTIVATE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void actualizarActionButton() {
        ...
        boolean success;
        switch(this.state) {
            case TamanhoBocadillo.ADD_STATE -> {
            ...
            case TamanhoBocadillo.UPDATE_STATE -> success = TamanhoPizza_Service.updateById(this.entityLoadedForm.nro_TamanhoPizza, this.entityLoadedForm);
            case TamanhoBocadillo.INACTIVATE_STATE -> success = TamanhoPizza_Service.inactivateById(this.entityLoadedForm.nro_TamanhoPizza);
            case TamanhoBocadillo.ACTIVATE_STATE -> success = TamanhoPizza_Service.activateById(this.entityLoadedForm.nro_TamanhoPizza);
            case TamanhoBocadillo.DELETE_STATE -> success = TamanhoPizza_Service.deleteById(this.entityLoadedForm.nro_TamanhoPizza);
    ...
    public void onElementSelected(ListSelectionEvent e) {
        ...
        // Change State
        this.state = TamanhoBocadillo.HOVER_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void enableDisableButtons(){
        ...
        switch(this.state){
            case TamanhoBocadillo.HOVER_STATE:
                this.formularioPanel.getjButton_modificar().setEnabled(false);
            case TamanhoBocadillo.SELECT_STATE:
