 ...
 * @author anjab
 */
public class TamanhoPizza_Cargo extends JFrame {
    ...
    private void setupJFrame() {
        this.formularioPanel = new TamanhoPizza_CargoPanel(this);
    ...
    public void adicionarActionButton() {
        // Change State
        this.state = TamanhoPizza_Cargo.ADD_STATE;
    ...
    public void modificarActionButton() {
        // Change State
        this.state = TamanhoPizza_Cargo.UPDATE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void eliminarActionButton() {
        // Change State
        this.state = TamanhoPizza_Cargo.DELETE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void cancelarActionButton() {
        // Change State
        this.state = TamanhoPizza_Cargo.SELECT_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void inactivarActionButton() {
        // Change State
        this.state = TamanhoPizza_Cargo.INACTIVATE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void reactivarActionButton() {
        // Change State
        this.state = TamanhoPizza_Cargo.ACTIVATE_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void actualizarActionButton() {
        ...
        boolean success;
        switch(this.state) {
            case TamanhoPizza_Cargo.ADD_STATE -> {
            ...
            case TamanhoPizza_Cargo.UPDATE_STATE -> success = TamanhoPizza_Service.updateById(this.entityLoadedForm.nro_TamanhoPizza, this.entityLoadedForm);
            case TamanhoPizza_Cargo.INACTIVATE_STATE -> success = TamanhoPizza_Service.inactivateById(this.entityLoadedForm.nro_TamanhoPizza);
            case TamanhoPizza_Cargo.ACTIVATE_STATE -> success = TamanhoPizza_Service.activateById(this.entityLoadedForm.nro_TamanhoPizza);
            case TamanhoPizza_Cargo.DELETE_STATE -> success = TamanhoPizza_Service.deleteById(this.entityLoadedForm.nro_TamanhoPizza);
    ...
    public void onElementSelected(ListSelectionEvent e) {
        ...
        // Change State
        this.state = TamanhoPizza_Cargo.HOVER_STATE;
        // Enable and disable jbuttons
        enableDisableButtons();
    ...
    public void enableDisableButtons(){
        ...
        switch(this.state){
            case TamanhoPizza_Cargo.HOVER_STATE:
                this.formularioPanel.getjButton_modificar().setEnabled(false);
            case TamanhoPizza_Cargo.SELECT_STATE:
